<nav class="sidebar sidebar-offcanvas sidebar-fixed" id="sidebar" style="background-color: #10243c">
    ...
    <ul class="nav">
        <li class="nav-item">
           <a class="nav-link {{ request()->routeIs('dashboard.rt') ? 'active' : '' }}" href="{{ route('dashboard.rt') }}">
        ...
        <li class="nav-item">
            ...
            <ul id="master-pengajuan" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                <li class="nav-item">
<a href="{{ route('rt.suratmasuk.index') }}" class="nav-link {{ request()->routeIs('rt.suratmasuk.*') ? 'active' : '' }}">
    Surat Masuk
</a>

             </li>
        <li class="nav-item">
            <a href="{{ route('rt.suratselesai.index') }}" class="nav-link {{ request()->routeIs('rt.suratselesai.*') ? 'active' : '' }}">Surat Selesai</a>
        </li>
        <li class="nav-item">
            <a href="{{ route('rt.suratditolak.index') }}" class="nav-link {{ request()->routeIs('rt.suratditolak.*') ? 'active' : '' }}">Surat Ditolak</a>
        </li>
            </ul>
        </li>
    </ul>
